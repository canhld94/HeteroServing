 ...
 * @b About: collections of useful marco and template that I find useful but not
 *closely related
 * to the project
 ***************************************************************************************/
...
//! DON'T use it recursively. If you do it recursively, only read the innermost
//! result
...
#define PROFILE_DEBUG(NAME, ...)                         \
  ...
  std::cout << "[::PROFILE] " << NAME << ": "            \
            << PROFILE_elapsed_seconds.count() << " ms" << std::endl;
